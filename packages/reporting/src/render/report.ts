...
import {
  ...
  sAeoGaps,
  sAeoProgress,
  sAeoReadinessSection,
  sCannibalization,
  sCompletedWork,
  sContent,
  sContentOpportunities,
  sContentPublished,
  sContentQuality,
  sContentWork,
  sCriticalProblems,
  ...
  sGeoGaps,
  sGeoProgress,
  sGeoReadinessSection,
  sHighPriorityProblems,
  sInternalLinking,
  sIssues,
  sIssuesResolvedDetailed,
  sKeywordImprovements,
  sKeywordVisibility,
  sNextPriorities,
  sOnPageFindings,
  sOrganicPerformance,
...
const EXECUTIVE_SECTIONS: SectionFn[] = [
  sExecutiveSummary,
  sCurrentVsPrevious,
  sCurrentVsBaseline,
  sSeoProgress,
